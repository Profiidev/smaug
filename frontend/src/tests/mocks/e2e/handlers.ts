...
const client: Client = createClient(createConfig<ClientOptions>()),
   ...
   */
  updaterWs = ws.link('*/api/ws/updater'),
  /**
   ...
   */
  publicUpdaterWs = ws.link('*/api/notes/update/*'),
  /**
   ...
   */
  appLoginWs = ws.link('*/api/auth/app/device_login'),
  /**
